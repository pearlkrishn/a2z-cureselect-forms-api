...
export const form = {
  ...
  allergies: {
    ...
    schema: {
      ...
      rashes_on_the_skin: { label: String, value: String },
  ...
  vitals: {
    ...
    schema: {
      ...
      icterus: { label: String, value: String },
      height: Number,
      weight: Number,
      systolic: Number,
      diastolic: Number,
  ...
  history: {
    ...
    value: {
      ...
      dermal: [
        ...
        ],
        {
          ...
          multi: true,
          option_source: 'url',
          option_url: `${process.env.TELEVET_API_URL}/masters/dermal/clinical_sign`,
          option_method: 'GET',
          option_label: 'name',
          option_slug: 'slug',
          // options: [
        ...
        },
        {
          ...
          multi: true,
          option_source: 'url',
          option_url: `${process.env.TELEVET_API_URL}/masters/dermal/body_area`,
          option_method: 'GET',
          option_label: 'name',
          option_slug: 'slug',
          // options: [
        ...
        },
        {
          ...
          multi: true,
          option_source: 'url',
          option_url: `${process.env.TELEVET_API_URL}/masters/dermal/treatment_or_medication`,
          option_method: 'GET',
          option_label: 'name',
          option_slug: 'slug',
          // options: [
    ...
    schema: {
      ...
      pseudo_pregnancy: { label: String, value: String },
      staple: String,
      table_food: String,
      treats: String,
      grooming: { label: String, value: String },
      breeder: String,
      name: String,
      remarks: String,
      dosage: String,
